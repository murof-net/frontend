    ...
    <div class="flex justify-center items-center text-center">
        ...
        <CardHeader>
            ...
            <CardDescription class="text-balance text-muted-foreground p-1">
                    Enter your details to access your account <br/> Go to the <a class="underline hover:text-primary" href="/auth/register">registration</a> or <a class="underline hover:text-primary" href="/auth/login">login</a> instead
            </CardDescription>
        </CardHeader>
        <CardContent>
