...
<div class="w-full">
    <div class="flex justify-center items-center text-center">
        <Card class="p-4 m-4">
        <CardHeader>
            <CardTitle class="font-robomo text-3xl font-bold p-2">Authentication</CardTitle>
            <CardDescription class="text-balance text-muted-foreground p-1">
                    Enter your details to access your account. Alternatively, go to the <a class="underline hover:text-primary" href="/auth/register">registration</a> or <a class="underline hover:text-primary" href="/auth/login">login</a> instead
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div class="grid gap-4">
                ...
                <div class="grid grid-cols-2 gap-4 my-1">
                    ...
                    <Button variant="outline" class="w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mx-1" x="0px" y="0px" fill="currentColor" height="100%" viewBox="0 0 24 24">
